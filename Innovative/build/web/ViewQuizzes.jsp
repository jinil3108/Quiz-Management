<%-- 
    ...
    Created on : 23-Apr-2022, 7:54:02 AM
            ...
            <span class="button">
                ...
                <%
                    ...
                    if(dao.getTotalQuiz((String)session.getAttribute("userLogin"))>0)
                    {
                        ...
                        %>
                        <div class="btn">
                                <input type="submit" value="Show completed quiz" style="position:relative; margin-left: 720%" onclick="window.location.href='CompletedQuiz.jsp'"/>                                
                            </div>
                        ...
                        <s:query dataSource="${snapshot}" var = "rs">
                            SELECT * from quizzes where email="<%= session.getAttribute("userLogin")%>" and visited="false";
                         </s:query>
                        ...
                        <c:forEach var = "row" items = "${rs.rows}">
                            ...
                            <div class="contain">
                                ...
                                <span><a class="startbox" href="specificquiz.jsp?id=<c:out value = "${row.id}"/>">
                                         Start Quiz <i class="fa fa-arrow-right" aria-hidden="true"></i></a></span>
                                
                                <p>Marks: <c:out value = "${row.total_marks}"/></p>
                            </div>
